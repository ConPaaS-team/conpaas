#!/bin/bash
services="php mysql condor ipop git selenium hadoop scalaris xtreemfs cds"
...
do
	...
	php|mysql|condor|ipop|git|selenium|hadoop|scalaris|xtreemfs|cds) eval ${uc}_SERVICE=true ;;
