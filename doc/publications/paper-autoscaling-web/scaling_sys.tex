...
\fixme{Write a link to present the rest of subsections.}
%In the following we ..
...
In order to decide when to trigger any of these two scaling actions, our system uses the following three methods: 
\begin{itemize}
...
\fixme{Some parts of this subsection could be omitted.}
...
\fixme{I could omit the use of the SLO penalty, as it is a constant in my experiments. Instead I could say that the user decides what they need.}
