...
\BlankLine
\emph{Ideal\_Throughput$_{inst}$} = $\dfrac{\emph{CPU\_usage$_{inst}$} } {\emph{Num\_requests$_{inst}$} }$  \; \label{alg:throughput_end}
\BlankLine
...
\fixme{Calculate MAPE error for the forecasting results}
