...
\hector{Note that, static provisioning was utilized to execute this trace in order to get response values totally independent of any scaling decisions. I executed this experiments using 4VMs for the backends so it was over-provisioned. 
