...
vs.\ complex reauests. Our algorithm therefore associates a higher
...
\emph{s\_bck} =\emph{s\_bck} - \emph{w$_i$} \textbf{or} \emph{s\_out} =\emph{s\_out} - \emph{w$_i$}\;\label{alg:thr3}
}}
