...
wang_appraise:_2009}. % By using real production applications, new
...
\corina{I reformulated this because I think it is better to be more
constructive and state that we not only look for the cause, but
we also try to see if there is a solution; also, it could be that
more than one of these 3 possible causes are real}
