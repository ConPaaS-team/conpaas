...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.75\linewidth,height=3cm]{images/optimalTree_initial}
  \end{center}
\vspace{-3mm}
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.8\linewidth,height=3.5cm]{images/optimalTree_selection}
  \end{center}
\vspace{-3mm}
