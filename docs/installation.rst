...
http://www.conpaas.eu/dl/cpsdirector-1.3.0.tar.gz. The tarball includes an
...
#. Download http://www.conpaas.eu/dl/cpsdirector-1.3.0.tar.gz and
   uncompress it
...
As root::
    ...
    $ sudo easy_install http://www.conpaas.eu/dl/cpsclient-1.3.0.tar.gz
...
a Python virtual environment if ``virtualenv`` is available on your machine::
    ...
    $ easy_install http://www.conpaas.eu/dl/cpsclient-1.3.0.tar.gz
...
http://www.conpaas.eu/dl/cpsfrontend-1.3.0.tar.gz. 
