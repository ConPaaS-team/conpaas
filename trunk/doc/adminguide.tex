...
\DefineVerbatimEnvironment%
  {code}%
  {Verbatim}%
  {frame=single,framesep=1mm,fontsize=\scriptsize\rm,resetmargins=true}
...
\item Copy all files from the \verb+frontend/conf+ directory to a
  ...
  variable should be described in the config file itself. If you are
  installing ConPaaS on EC2 you do not need to edit file
