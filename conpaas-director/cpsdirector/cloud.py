...
class ManagerController(Controller):
    ...
    #def _get_context_file(self, cloud):
        ...
        mngr_certs = self._get_certificate(email="info@conpaas.eu", cn="ConPaaS",org="Contrail")
...
def startapp(user_id, cloud_name, app_id, vpn, controller=None):
    ...
    return node['Address'], node['ID'], cloud.get_cloud_name(), controller
    #return node.ip, node.vmid, cloud.get_cloud_name()
