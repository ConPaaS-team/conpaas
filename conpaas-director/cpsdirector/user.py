    ...
    def __call__(self, fn):
        ...
        def decorated(*args, **kwargs):
            ...
            if self.role == 'manager':
                ...
                # TODO (genc): replacing the last 4 lines because the service_locator contains the app_id so we check if the application belongs to the user
...
def credit():
    ...
    log('Decrement user credit: aid=%s, old_credit=%s, decrement=%s' % (
        app_id, g.application.user.credit, decrement))
